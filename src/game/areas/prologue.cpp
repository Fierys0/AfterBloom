...
// ---------------------------------------------------------------
// Default prologue script builder
// ---------------------------------------------------------------
std::vector<VNLine> BuildDefaultPrologueScript() {
  ...
  return {
    ...
    {"Narrator",
     "Amidst the cloying scent of those flowers, a coffin was carried by the hands of people.", "", ""},
    {"Narrator",
     "My father's coffin is set within the beautiful flowers, is simply hideous.", "", ""},
    {"Narrator", "I always wonder, what the world look like inside that wooden box?", "", ""},
    ...
    {"Narrator",
     "What about the people around me? Are they sad after all? Do they felt heart broken?", "", ""},
    {"Narrator",
     "A crack runs through my heart for just a moment. The memory of me and my father together.", "", ""},
    {"Narrator",
     "The death of a man who was a great warrior for my kingdom ended with an ordinary funeral.", "", ""},
    {"Narrator",
     "Perhaps thinking that way was just childish delusion, a way to enact the most insulting revenge as possible against my father",
     "", ""},
    {"Narrator", "Truthfully, i don't know.", "", ""},
    {"Narrator", "but-", "", ""},
    {"Narrator",
     "Either way, it was the day where a person that i shared blood connection with vanished from this world.",
     "", ""},
    ...
    {"Nao", "Hmmm? Not really.", "", ""},
    {"???", "Nao...", "", ""},
    {"Narrator", "With sorrowful expression, a face i have seen for years peers into mine", "", ""},
    ...
    {"Narrator", "An April afternoon, with a slight chill lingering in the wind.", "", ""},
...
void PrologueState::Init() {
  ...
  testFont = Fumbo::Assets::LoadFont("assets/fonts/Montserrat-ExtraBold.ttf", 24);
  ...
  textStyle.enableShadow         = false; // Disable shadow for better readability on light theme
...
// ---------------------------------------------------------------
// SetupScene - advance to sceneNum, handling CG + music swaps
// ---------------------------------------------------------------
...
// ---------------------------------------------------------------
// SkipAll - immediately trigger fade-out (end of VN)
// ---------------------------------------------------------------
